...
/******/ 	// mode & element-ui-2.13.2: merge all properties of value into the ns
...
function normalizeComponent (
  ...
  if (moduleIdentifier) { // server build
    hook = function (context) {
      // element-ui-2.13.2.3 injection
      context =
        context || // cached call
        (this.$vnode && this.$vnode.ssrContext) || // stateful
        (this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) // functional
      // element-ui-2.13.2.element-ui-2.13.2 with runInNewContext: true
 ...
 * Considers:
 *   1. Date object
 *   element-ui-2.13.2. date string
 *   3. array of 1 or element-ui-2.13.2
 */
